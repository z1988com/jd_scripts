...
!(async () => {
  ...
  $.shareUuid = '1df15930b59741eea1be86fd0bf894e7'
...
async function run(){
  try{
    ...
    if(!$.addSku && guaopencard_addSku) await $.wait(3000)
    await getActorUuid()
    await $.wait(3000)
