...
================Loon==============
[Script]
cron "57 59 9  * * *" script-path=jd_europeancup.js,tag=欧洲狂欢杯

===============Surge=================
欧洲狂欢杯 = type=cron,cronexp="57 59 9  * * *",wake-system=1,timeout=3600,script-path=jd_europeancup.js

============小火箭=========
欧洲狂欢杯 = type=cron,script-path=jd_europeancup.js, cronexpr="57 59 9  * * *", timeout=3600, enable=true
*/
const $ = new Env('狂欢欧洲杯');
