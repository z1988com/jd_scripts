...
$.authorCode =  'c8211678b2ed4db2af83d9bfdcd13369'; 
if( cookiesArr.length ==1 ){
	$.authorCode=  '5b59c38e1b2e4641a7eb7499a382d8e4';
}
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            await marry();
            //await $.wait(2000)
			if(true || $.index % 3 == 0) console.log('休息1分钟，别被黑ip了\n可持续发展')
			if(true || $.index % 3 == 0) await $.wait(parseInt(Math.random() * 5000 + 60000, 10))
            if ($.bean > 0) {
