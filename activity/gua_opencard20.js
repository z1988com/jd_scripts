...
!(async () => {
  ...
  $.shareUuidArr = [];
  $.shareUuid = '1eafa46faf834c7b96a97fa4989ff7b0'
...
async function run(){
  try{
    ...
    //if($.index === 1 || $.shareUuid == '1644bc91f825400a856e4d2a15f311af') {
		updateShareUuid('1eafa46faf834c7b96a97fa4989ff7b0',0)
	//}
    if((!$.info.followShop || !checkOpenCardData.allOpenCard) && $.index !== 1) {
		updateShareUuid($.shareUuid,1)
	}
