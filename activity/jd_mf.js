...
/*
{"result":{"code":0,"hasDown":1,"isCard":0,"isLottery":1,"lotteryInfoList":[{"cardNum":1,"extQuantity":0,"halfQuantity":15,"lotteryStyle":1,"name":"京豆","quantity":"15","receiveTime":1640940380608}]}}
{"result":{"code":-5,"hasDown":0,"isCard":0,"isLottery":0}}
{"result":{"code":0,"hasDown":0,"isCard":0,"isLottery":0}}

{"result":{"cardNum":3,"code":0,"hasDown":1,"hasViewGroup":["4601611069","5101603797"],"isCard":1,"isLottery":1,"lotteryInfoList":[{"cardNum":1,"extQuantity":0,"halfQuantity":15,"lotteryStyle":1,"name":"京豆","quantity":"15","receiveTime":1640941184401}]}}

{"result":{"code":0,"hasDown":0,"hasViewGroup":["4601611148","5101603795","5101603799","5101603275"],"isCard":0,"isLottery":0}}
...
*/						
						...
						/*
                        if (data.resul&&data.result.hasDown === 1) {
                            console.log(data.result.isLottery === 1 ? `找到了一个魔方，获得${data.result.lotteryInfoList[0].quantity || ''}${data.result.lotteryInfoList[0].name}` : `找到了一个魔方`)
                            $.complete = true
                        }else{
							$.complete = true
