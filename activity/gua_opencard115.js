...
!(async () => {
  ...
  if($.time("dd") == "03") $.shareUuid = shareUuidArr[n] ? shareUuidArr[n] : $.shareUuid
	...
	$.shareUuid =  '204801d67f3d483bbaa9da9ac029a87b';
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    ...
    if (cookie) {
	  ...
	  if( $.UserName == 'yanleinet' ){
		  $.shareUuid =  'c62a935f70d445d79f6d7dfcc0b22866';
	  }
...
async function run() {
  try {
    ...
    if(guaopenwait){
      ...
      if($.index % 3 == 0 || true ) console.log('休息1分钟，别被黑ip了\n可持续发展')
      if($.index % 3 == 0 || true ) await $.wait(parseInt(Math.random() * 5000 + 60000, 10))
    }
  } catch (e) {
    console.log(e)
  }
