        ...
        $.post(MyRequest,async(error, response, data) =>{
            try{
                ...
                if(result.code == 200){
                    ...
                    let list1 = result.data.taskList.find(item => item.taskId == 228)
                    num1 = Number(list1.totalNum) - Number(list1.finishNum)
					
					console.log(`num228=${num1}`);
                    if(num1 > 0){
                    ...
                    let list3 = result.data.taskList.find(item => item.taskId == 229)
                    num3 = Number(list3.totalNum) - Number(list3.finishNum)
					console.log(`num229=${num3}`);
                    if(num3 > 0){
                    ...
                    let list4 = result.data.taskList.find(item => item.taskId == 230)
                    num4 = Number(list4.totalNum) - Number(list4.finishNum)
					console.log(`num230=${num4}`);
                    if(num4 > 0){
                    ...
                    let list5 = result.data.taskList.find(item => item.taskId == 231)

                    num5 = Number(list5.totalNum) - Number(list5.finishNum)
					console.log(`num231=${num5}`);
                    if(num5 > 0){
