...
================Loon==============
[Script]
cron "11 1,20 * * *" script-path=jd_cash_panda.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="11 1,20 * * *",wake-system=1,timeout=3600,script-path=jd_cash_panda.js

============小火箭=========
签到领现金 = type=cron,script-path=jd_cash_panda.js, cronexpr="11 1,20 * * *", timeout=3600, enable=true
 */
