...
!(async () => {
  $.newShareCodes = []
  $.authorCode = await getAuthorShareCode('http://www.z1988.com/tools/shareCodes/jd_bean_home.php')
          ...
          if (safeGet(data)) {
            ...
            if(data.data.jklInfo) {
              ...
              if (!shareCode) {
                ...
                console.log(`\n京东账号${$.index} ${$.nickName || $.UserName} 抢京豆邀请码：shareCode=${shareCode} groupCode=${groupCode}\n`);
