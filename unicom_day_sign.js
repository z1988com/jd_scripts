...
/*
任务列表
https://act.10010.com/SigninApp/superSimpleTask/getTask
*/
  ...
  return new Promise(resolve => {
    const options = {
      ...
      headers: {
		...
		'user-agent':'Mozilla/5.0 (Linux; Android 9; PCT-AL10 Build/PQ3B.190801.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.114 Mobile Safari/537.36; unicom{version:android@11.0300,desmobile:${$.nickName}};devicetype{deviceBrand:HUAWEI,deviceModel:PCT-AL10};{yw_code:}',
