...
function readToken() {
  return new Promise(resolve => {
    $.get({url: `000http://share.turinglabs.net/api/v3/joy/query/1/`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
...
function getFriendPins() {
  return new Promise(resolve => {
    $.get({
      url: "000https://cdn.jsdelivr.net/gh/gitupdate/friendPin@main/friendPins.json",
      headers:{
